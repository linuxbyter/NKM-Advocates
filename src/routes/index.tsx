      ...
      >
        <div className="mx-auto flex max-w-[1180px] items-center justify-between px-7 py-[18px] transition-all duration-200">
          <div className="flex flex-col leading-none">
            <span className="font-serif text-[19px] font-bold tracking-tight text-paper-text">NKM ADVOCATES</span>
            <span className="font-mono text-[10px] tracking-[0.18em] text-brass-soft">ADVOCATES &amp; CONSULTANTS</span>
          </div>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden -mt-[68px]">
        ...
        <div className="relative z-10 max-w-[720px] mx-auto px-7 py-[120px_28px_90px] text-center">
          ...
          <div className="flex gap-3.5 flex-wrap justify-center">
            <a href="#book" className="font-mono text-[13px] tracking-wide bg-clay text-paper-text px-[22px] py-[14px] border border-clay transition-all duration-150 hover:-translate-y-0.5 hover:shadow-[0_6px_18px_rgba(138,60,41,0.28)]">
              Book a Consultation
            </a>
            <a href="#departments" className="font-mono text-[13px] tracking-wide bg-transparent text-paper-text px-[22px] py-[14px] border border-paper-text-dim transition-all duration-150 hover:-translate-y-0.5 hover:border-brass-soft hover:text-brass-soft">
              View Departments
            </a>
          </div>
          ...
          <div className="relative">
            <div ref={trackRef} onScroll={() => {
              ...
              {[
                ...
                ["DR-03", "Debt Recovery &amp; Small Claims", "Structured collections for unpaid invoices and small claims representation."],
                ["ADR-04", "Mediation, Arbitration &amp; ADR", "Out-of-court resolution for commercial and family disputes."],
                ["IP-05", "Intellectual Property", "Trademark, copyright, and brand protection for growing businesses."],
                ["NGO-06", "NGO &amp; Non-Profit Registration", "Registration and compliance for nonprofits and diaspora-funded initiatives."],
                ["FAM-07", "Family Law", "Succession, custody, and power of attorney — with experience supporting clients abroad."],
      ...
      <section className="py-24 bg-ink" id="serve">
        <div className="mx-auto max-w-[1180px] px-7">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              ["Kenya", "SMEs &amp; Individuals", "Company formation, contracts, compliance, and dispute resolution for Kenyan businesses and families — in person or entirely online."],
      ...
      <section className="py-24 bg-card" id="insights">
        <div className="mx-auto max-w-[1180px] px-7">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[18px]">
            {[
              ["Real Estate · Diaspora", "Buying Land in Kenya From Overseas: A Pre-Purchase Checklist", "May 2026"],
        ...
        <div className="mx-auto max-w-[1180px] px-7">
          <div className="flex flex-wrap items-end justify-between gap-6 mb-4">
            <div>
              ...
              <h2 className="font-serif text-[clamp(26px,3.2vw,38px)] font-semibold tracking-tight text-paper-text">The NKM Podcast.</h2>
            </div>
            <a href="#" className="font-mono text-[12.5px] text-brass-soft inline-flex items-center gap-1.5 group">
              All Episodes
              <span className="transition-transform duration-200 group-hover:translate-x-1">→</span>
            </a>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-14 items-center">
            <div>
              <div className="flex mb-6">
                {["A", "·", "·", "RW", "HM"].map((init, i) => (
                  <div key={i} className={`w-[58px] h-[58px] rounded-full bg-ink text-brass-soft flex items-center justify-center font-serif font-semibold text-[17px] border-2 border-card ${i > 0 ? '-ml-[14px]' : ''}`}>
                    {init}
                  </div>
                ))}
              </div>
        ...
        <div className="mx-auto max-w-[1180px] px-7 text-center">
          ...
          {success ? (
            <div className="max-w-[520px] mx-auto bg-white/[0.04] border border-line-dark p-8 text-center">
              <svg className="w-12 h-12 mx-auto mb-4 text-brass" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="flex gap-3.5 flex-wrap justify-center mt-10">
            <a href="tel:0707329013" className="font-mono text-[13px] tracking-wide bg-clay text-paper-text px-[22px] py-[14px] border border-clay transition-all duration-150 hover:-translate-y-0.5 hover:shadow-[0_6px_18px_rgba(138,60,41,0.28)]">
              Call 0707 329 013
            </a>
            <a href="https://wa.me/254707329013" target="_blank" rel="noopener noreferrer"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.3fr_1fr_1fr_1fr_1.2fr] gap-9 pb-[46px] pt-[60px]">
            ...
            <div>
              ...
              <ul className="list-none grid gap-2.5">
                {["Business &amp; SME Advisory", "Real Estate", "Debt Recovery", "Mediation &amp; ADR", "Intellectual Property", "NGO Registration", "Family Law", "Data Protection"].map((d) => (
                  <li key={d}><a href="#departments" className="hover:text-paper-text transition-colors" dangerouslySetInnerHTML={{__html: d}} /></li>
                ))}
              </ul>
            </div>
            <div>
              <h4 className="font-mono text-[11px] tracking-[0.1em] uppercase text-brass-soft mb-3.5">Firm</h4>
              <ul className="list-none grid gap-2.5">
                {["Who We Serve", "Insights", "Podcast", "Our Team", "Careers"].map((l) => (
                  <li key={l}><a href={l === "Careers" ? "#" : "#" + l.toLowerCase().replace(/\s+/g, "")} className="hover:text-paper-text transition-colors">{l}</a></li>
                ))}
              </ul>
            </div>
            <div>
              <h4 className="font-mono text-[11px] tracking-[0.1em] uppercase text-brass-soft mb-3.5">Quick Links</h4>
              <ul className="list-none grid gap-2.5">
                {["Privacy Policy", "Disclaimer", "FAQ"].map((l) => (
                  <li key={l}><a href="#" className="hover:text-paper-text transition-colors">{l}</a></li>
                ))}
              </ul>
            </div>
            <div>
